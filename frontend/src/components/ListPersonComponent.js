                        ...
                        <tr key={person.id}>
                            ...
                            <td>
                                <div className='d-flex justify-content-between'>
                                    <button type="button" class="btn btn-primary" onClick={(e) => navigate(`/update-person/${person.id}`)}>
                                    ...
                                    <button type="button" class="btn btn-danger ml-2" onClick={() => deletePerson(person.id)}>
